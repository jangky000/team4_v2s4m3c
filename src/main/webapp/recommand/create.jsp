...
<div style="width: 80%; margin: 20px auto;">
  ...
  <TABLE class='tbl_sty' style="width: 80%; margin: 10px auto;" >
            ...
            <TR>
                ...
                <TD class='itemgrp_table_td'> 
                  <c:forEach var="Itemgrp_Item_VO" items="${itemlist }">                
                    <input name="checkbox" value="${Itemgrp_Item_VO.itemVO.itemno }" type="checkbox" id="checkbox">
                      <label for="${Itemgrp_Item_VO.itemVO.itemno }">${Itemgrp_Item_VO.itemVO.item_name }</label>      
                  </c:forEach>
                </TD>
            </TR>
            <TR>         
