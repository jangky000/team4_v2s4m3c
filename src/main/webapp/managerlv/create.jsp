...
<FORM name='frm' method='POST' action='./create.do' class="form-horizontal">
  <div class="form-group">
     ...
     <div class="col-md-9">
       <input type='text' name='managerlv_name' value='' required="required" 
  ...
  <div class="form-group">
     ...
     <div class="col-md-9">
       <input type='text' name='managerlv_pay' value='' required="required" 
                  autofocus="autofocus" class="form-control" style='width: 50%;'>
     </div>
  </div>  
  <div class="form-group">
     ...
     <div class="col-md-9">
       <input type='text' name='managerlv_do' value='' required="required" 
                  autofocus="autofocus" class="form-control" style='width: 50%;'>
     </div>
  </div>   
