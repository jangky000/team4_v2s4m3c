 ...
 <div style="margin:20px auto; width:80%">
  ...
  <DIV style='width: 100%;'>
    <FORM name='frm' method='POST' action='./update.do' class="form-horizontal">
      ...
      <div class="form-group">   
        <div class="col-md-12">
          <textarea class="form-control" name='note_content' rows='10' placeholder="내용">${noteVO.note_content }</textarea>
        </div>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-12">
            <input type='number' name='note_seqno' value='${noteVO.note_seqno }'
              required="required" placeholder="출력 순서" min="1"
