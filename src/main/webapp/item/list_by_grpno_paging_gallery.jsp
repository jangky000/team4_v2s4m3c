...
div{
 style='width: 24%; float: left; margin: 0.5%; padding: 0.5%; background-color: #EEEFFF;
}
  .panel-primary:hover {
  ...
  <div style="width: 80%; margin: 20px auto;">
   ...
   <br>
    ...
    <c:forEach var="itemgrp_Item_join" items="${list }" varStatus="status">
      ...
      <!-- 하나의 이미지 -->
      <DIV style='width: 24%; float: left; margin: 0.5%; padding: 0.5%; '>
        <c:choose>
          <c:when test="${fsize > 0}">
            <!-- 파일이 존재하면 -->
            <c:choose>
              <c:when test="${thumb.endsWith('jpg') || thumb.endsWith('png') || thumb.endsWith('gif')}">
                ...
                <div class="panel panel-primary">
                  ...
                  <div class="panel-body">
                    <a href="./read.do?itemno=${itemno}">
                     <IMG src="./storage/main_images/${thumb }"  style='width: 100%; height: 150px;'>
                    </a>
                  </div>
