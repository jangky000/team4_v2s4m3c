...
<div style="width: 80%; margin: 20px auto;">
  <DIV class='itemgrp_title_line'>상품 삭제</DIV>
  
  <FORM name='frm' method='POST' action='./delete.do'>
    <!-- itemgrp 테이블로부터 값을 전달받지 못한 경우는 값을 직접 지정하여 개발 -->
    <input type="hidden" name="itemno" id="itemno"value="${itemVO.grpno }">
    <input type="hidden" name="itemno" id="itemno"value="${param.itemno }">
      <DIV class='itemgrp_title_line'>상품 수정
        삭제되는 글: ${itemVO.item_name }    
      </DIV>
