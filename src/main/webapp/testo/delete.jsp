...
<jsp:include page="/menu/top.jsp" flush='false' />
 <div class= "material_center">
      <div class='title_line_center'><span class="title">♥ 질문항목 ${testoVO.testo_content} 삭제♥</span></div>
          <FORM name='frm' method='POST' action='./delete.do'>
              <input type='hidden' name='testono' value='${param.testono}'>
        
              <div class="form-group">   
                <div class="text_center_delete" style='text-align: center;'>
                  ${testoVO.testo_content }를 삭제하시겠습니까? <br><br>삭제하시면 복구 할 수 없습니다.<br><br>
