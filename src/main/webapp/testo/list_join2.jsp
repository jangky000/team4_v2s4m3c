...
<body>
  ...
  <div class='material'>
    ...
    <c:forEach var="testq_Testo_join" items="${list}">
      ...
      <c:set var="testq_img" value="${testq_Testo_join.q_testq_img}" />
    ...
    <div></div>    
      <c:choose>
          <c:when test="${testqno_old != testqno}">
                  ${testqno}
                  <c:set var="testqno_old"
              value="${testqno}" />
          </c:when>
          <c:otherwise>
                 &nbsp;
...
<div>
             ...
             <img src="../testq/storage/imgstorage/${testq_Testo_join.q_testq_img}">


</div>


        ${testo_content} ${testo_seqno}
        <!-- </a>  -->



<%--         <A href="./update_seqno_down.do?testono=${testono }"><img
          src="../css/images/down_icon.png"
          style="width: 20px; margin: 3px;" /></A> <A
          href="./update_seqno_up.do?testono=${testono }"><img
          src="../css/images/up_icon.png"
          style="width: 20px; margin: 3px;" /></A> <A
          href="./update.do?testono=${testono }"><img
          src="../css/images/edit_icon.png"
          style="width: 18px; margin: 3px;" /></A> <A
          href="./delete.do?testono=${testono }"><img
          src="../css/images/delete_icon.png"
          style="width: 25px; margin: 3px;" /></A> --%>
    </c:forEach>
