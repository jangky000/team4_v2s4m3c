...
<body onload="showImage()">
  ...
  <c:forEach var="memlvVO" items="${list }">  <!-- request 객체에 접근 -->
    ...
    <div style="margin:20px auto; font-size:20px;">${memlvVO.memlv_name }</div>
	<img src='./img/${memlvVO.memlv_img }'/><br>
	<b>조건</b> : ${memlvVO.memlv_condition } <br>
	<b>혜택</b> : ${memlvVO.memlv_benefit }<br><br>
