...
<FORM name='frm' method='POST' action='./create.do' class="form-horizontal">
  <div class="form-group">
     ...
     <div class="col-md-9">
       <input type='text' name='memlv_name' value='' required="required" 
  ...
  <div class="form-group">
     ...
     <div class="col-md-9">
       <input type='text' name='memlv_condition' value='' required="required" 
                  autofocus="autofocus" class="form-control" style='width: 50%;'>
     </div>
  </div>  
  <div class="form-group">
     ...
     <div class="col-md-9">
       <input type='text' name='memlv_benefit' value='' required="required" 
                  autofocus="autofocus" class="form-control" style='width: 50%;'>
     </div>
  </div>   
