...
<input type='hidden' name='memlvno' id='memlvno' value='${memlvVO.memlvno }'>
  <div class="form-group">
     ...
     <div class="col-md-9">
       <input type='text' name='memlv_name' value="${memlvVO.memlv_name }" required="required" 
  ...
  <div class="form-group">
     ...
     <div class="col-md-9">
       <input type='text' name='memlv_condition' value='${memlvVO.memlv_condition }' required="required" 
                  autofocus="autofocus" class="form-control" style='width: 50%;'>
     </div>
  </div>  
  <div class="form-group">
     ...
     <div class="col-md-9">
       <input type='text' name='memlv_benefit' value='${memlvVO.memlv_benefit }' required="required" 
                  autofocus="autofocus" class="form-control" style='width: 50%;'>
     </div>
  </div>   
<br>
