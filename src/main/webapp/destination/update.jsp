...
<FORM name='frm' id="frm" method='POST' action='./update.do'>
  ...
  <input type='hidden' name='destinationno' id='destinationno' value='${param.destinationno }'>

  <div>
     <label for="recipient" style='font-size: 0.9em;'>배송받는 사람</label>  
       <input type='text' name='recipient' id='recipient' value='${destinationVO.recipient }' required="required" 
                  placeholder="배송받는 사람">
  </div>
  <div>
     <label for="recipient_phone" style='font-size: 0.9em;'>배송받는 연락처</label>  
       <input type='text' name='recipient_phone' id='recipient_phone' value='${destinationVO.recipient_phone }' required="required" 
                  placeholder="배송받는 연락처">
  </div>
  <br>
  <div>
     <label for="postcode" style='font-size: 0.9em;'>우편번호</label><br>  
       <input type='text' name='postcode' id='postcode' value='${destinationVO.postcode }' required="required" 
  ...
  <div>
     <label for="address1" style='font-size: 0.9em;'>주소</label>  
       <input type='text' name='address1' id='address1' value='${destinationVO.address1 }' required="required" 
                  placeholder="주소">
  </div>
   
  <div>
     <label for="address2" style='font-size: 0.9em;'>상세주소</label>  
       <input type='text' name='address2' id='address2' value='${destinationVO.address2 }' required="required" 
                  placeholder="상세주소">
  </div>
  <br><br> 
...
<br><br>
  <div>
    ...
    <button type="button" onclick="location.href='./list.do?memno=${memno}'">취소</button>
  </div>
